        ...
        class << self
          ...
          def embed_frameworks_input_paths(framework_paths, xcframeworks)
            ...
            xcframeworks.select { |xcf| xcf.build_type == BuildType.dynamic_framework }.each do |xcframework|
              ...
              input_paths.concat("#{BuildSettings.xcframework_intermediate_dir(name)}/#{name}.framework/#{name}")
            end
            input_paths
          end
          ...
          def embed_frameworks_output_paths(framework_input_paths, xcframeworks)
            ...
            xcframwork_paths = xcframeworks.select { |xcf| xcf.build_type.dynamic_framework? }.map do |xcframework|
              "${TARGET_BUILD_DIR}/${FRAMEWORKS_FOLDER_PATH}/#{xcframework.name}.framework"
            end
            paths + xcframwork_paths
          end
        end
